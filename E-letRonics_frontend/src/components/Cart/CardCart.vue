  ...
  <div class="bg-base-100 shadow-xl p-4 mt-4 max-w-xs">
    ...
    <div class="card-body">
      ...
      <button @click="deleteCartItem"
        class="ml-auto mb-4 cursor-pointer rounded-md border px-8 text-center text-gray-500 transition duration-150 ease-in-out hover:translate-y-1 hover:bg-rose-500 hover:text-white ">
        <svg xmlns="http://www.w3.org/2000/svg" height="35" width="14" viewBox="0 0 448 512">
          <path fill="#ffffff"
